...
rtds_action_github_repo = "grburgess/common_astro_models"
...
latex_documents = [
    (master_doc, 'common_astro_models.tex', u'Common Astro Models Documentation',
...
man_pages = [(master_doc, 'common_astro_models', u'Common Astro Models Documentation', [author], 1)]
...
texinfo_documents = [
    (master_doc, 'common_astro_models', u'Common Astro Models Documentation', author, 'common_astro_models',
