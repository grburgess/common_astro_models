...
common_astro_models_dev_log_handler = handlers.TimedRotatingFileHandler(
...
common_astro_models_dev_log_handler.setFormatter(_dev_formatter)
common_astro_models_dev_log_handler.setLevel(logging.DEBUG)
# now set up the usr log which will save the info

common_astro_models_usr_log_handler = handlers.TimedRotatingFileHandler(
    get_path_of_log_file("usr.log"), when="D", interval=1, backupCount=10
)

common_astro_models_usr_log_handler.setLevel(logging.INFO)
...
common_astro_models_usr_log_handler.setFormatter(_usr_formatter)
...
common_astro_models_console_log_handler = logging.StreamHandler(sys.stdout)
common_astro_models_console_log_handler.setFormatter(_console_formatter)
common_astro_models_console_log_handler.setLevel("INFO")
...
def silence_warnings():
    ...
    common_astro_models_usr_log_handler.addFilter(warning_filter)
    common_astro_models_console_log_handler.addFilter(warning_filter)
...
def activate_warnings():
    ...
    common_astro_models_usr_log_handler.removeFilter(warning_filter)
    common_astro_models_console_log_handler.removeFilter(warning_filter)


def update_logging_level(level):

    common_astro_models_console_log_handler.setLevel(level)
...
def setup_logger(name):
    ...
    log.addHandler(common_astro_models_dev_log_handler)

    log.addHandler(common_astro_models_console_log_handler)

    log.addHandler(common_astro_models_usr_log_handler)
